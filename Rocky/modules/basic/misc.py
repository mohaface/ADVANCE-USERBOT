...
from Rocky import START_TIME
from Rocky import SUDO_USER
from Rocky.helper.PyroHelpers import ReplyCheck
from Rocky.modules.help import add_command_help
from Rocky.modules.bot.inline import get_readable_time

alive_logo = ALIVE_PIC or "https://telegra.ph/file/bf119f709ebc525785ccc.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ѕυρρσят**: [Click](t.me/+xj59j0oSkpg1ZTJl)\n"
        f"├• **¢нαииєℓ**: [Click](t.me/XD_N3TWORK)"
...
async def repo(bot: Client, message: Message):
    ...
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://t.me/XD_N3TWORK\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://t.me/ROCKY_ISS_BACK")
